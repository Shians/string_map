...
```
download.files("https://github.com/Shians/string_map/raw/main/string_map.R", "R/string_map.R")
download.files("https://github.com/Shians/string_map/raw/main/string_map.R", "src/string_map.cpp")
```
